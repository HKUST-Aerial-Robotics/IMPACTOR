 ...
 * Description: This is the header file for the RootFinder class, which is
 *              used to find the roots of a polynomial. Modified from the
...
#ifndef _ROOT_FINDER_HPP
#define _ROOT_FINDER_HPP
...
namespace RootFinderPriv
{
    ...
    //              coeffs(lbound) != 0, coeffs(rbound) != 0, lbound < rbound
    {
        ...
        // std::cout << kojimaVec.size() << std::endl;
        kojimaVec.tail(1) /= 2.0; // the size of kojimavec could be 0, bug!!!
